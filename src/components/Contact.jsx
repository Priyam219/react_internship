    ...
    <div className="relative mx-auto w-full max-w-7xl bg-white text-gray-700">
      <div className="grid grid-cols-2">
        ...
        <div className="order-1 col-span-full">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3743.8704074606694!2d85.67170021412021!3d20.22270552018257!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a19ab347765fb0f%3A0xccb84948b4b2bdf6!2sGandhi%20Institute%20for%20Technology%20(GIFT)!5e0!3m2!1sen!2sin!4v1677007989682!5m2!1sen!2sin" 
        ...
        <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <form action="" className="mx-auto max-w-xl space-y-4" onSubmit={handleSubmit}>
            ...
            {/* ::Submit Button */}
            <div>
              <button type="submit" className="py-2 px-6 rounded bg-indigo-700 text-base text-white font-semibold uppercase ">Send Message</button>
            </div>
          </form>
        </div>
        ...
        <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl flex flex-col space-y-5">
            {/* ::Title Contact Us */}
            <h1 className="text-5xl font-bold xl:block hidden leading-tight text-black  underline decoration-indigo-700 decoration-4 underline-offset-4">
                        Contact Me
            ...
            <a href="#mail" className="inline-flex items-center text-sm text-blue-400 font-semibold hover:text-blue-500">
              mail-deyatanu@616gmail.com
            </a>
            {/* ::Address */}
            <p className="text-sm text-gray-500 leading-6">Mig-9 Kaling Vihar Square,Patrapada <br />751019 Bhubanswer<br /> Odisha</p>
            {/* ::Socials */}
